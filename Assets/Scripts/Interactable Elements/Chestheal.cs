...
public class Chestheal : MonoBehaviour
{
    ...
    private LootManagerHeal lootManager;
    ...
    void Start()
    {
        ...
        lootManager = this.gameObject.GetComponent<LootManagerHeal>();
    }
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.gameObject.tag == "Player" && !hasOpened)
        {
            ...
            // Set hasOpened to true to indicate that the chest has been opened
            hasOpened = true;
        }
    }
